...
describe('source registry',()=>{
  it('normalizes only controlled exact aliases',()=>{assert.equal(detectSource('cc_prod','2000')?.code,'CC_PROD');assert.equal(detectSource('monthly cc prod export','2000'),undefined);});
