                    ...
                    return (
                      <React.Fragment key={kodeAkun}>
                        ...
                        <tr className="bg-blue-50 font-semibold">
                          ...
                          <td colSpan={canEdit ? 15 : 14} className="px-4 py-3 text-left text-blue-900 bg-blue-50">
                            Kode Akun: {kodeAkun}
                          </td>
                          ...
                          return (
                            <React.Fragment key={vendorKey}>
                              <tr className="bg-green-50 font-semibold">
                                ...
                                <td colSpan={canEdit ? 15 : 14} className="px-4 py-3 text-left text-green-900 bg-green-50">
                                  Vendor: {vendor}
                                </td>
